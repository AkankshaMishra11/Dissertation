...
class PdfPagesix extends StatefulWidget {
  @override
  _PdfPagesixState createState() => _PdfPagesixState();
}

class _PdfPagesixState extends State<PdfPagesix> {
   String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('AIPT coding-TEST').child(enrollmentNo).child('Experiment 6').once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Experiment 6', // Your heading text
...
pw.RichText(
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Experiment 6', // Your heading text
