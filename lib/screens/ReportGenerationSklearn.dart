...
class PdfPageSklearn extends StatefulWidget {
  @override
  _PdfPageSklearnState createState() => _PdfPageSklearnState();
}

class _PdfPageSklearnState extends State<PdfPageSklearn> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('Sklearn').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Sklearn', // Your heading text
...
void _captureFacultySign() async {
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Sklearn', // Your heading text
