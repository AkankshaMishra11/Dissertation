...
class CCPdfPageTwo extends StatefulWidget {
  @override
  _CCPdfPageTwoState createState() => _CCPdfPageTwoState();
}

class _CCPdfPageTwoState extends State<CCPdfPageTwo> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('CC coding-TEST').child(enrollmentNo).child('Experiment 2').once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Experiment 2', // Your heading text
...
pw.RichText(
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Experiment 2', // Your heading text
