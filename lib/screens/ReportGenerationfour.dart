...
class PdfPagefour extends StatefulWidget {
  @override
  _PdfPagefourState createState() => _PdfPagefourState();
}

class _PdfPagefourState extends State<PdfPagefour> {
   String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('AIPT coding-TEST').child(enrollmentNo).child('Experiment 4').once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Experiment 4', // Your heading text
...
pw.RichText(
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Experiment 4', // Your heading text
