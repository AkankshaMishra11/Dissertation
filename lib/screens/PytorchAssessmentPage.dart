...
import 'package:firebase_core/firebase_core.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:stela_app/screens/ReportGenerationPytorch.dart';
...
void main() async {
  ...
  runApp(PytorchAssessmentPage());
}

class PytorchAssessmentPage extends StatefulWidget {
  @override
  _PytorchAssessmentPageState createState() => _PytorchAssessmentPageState();
}

class _PytorchAssessmentPageState extends State<PytorchAssessmentPage> {
...
late String section2= controller.text;
 ...
 List<String> correctAnswers = [
  // PyTorch basics questions
  "import torch", // Question 1
  "tensor", // Question 2
  "autograd", // Question 3
  "nn.Module", // Question 4
  "DataLoader", // Question 5
  "optim", // Question 6
  "backward", // Question 7
  "cuda", // Question 8
  "torchvision", // Question 9
  "save", // Question 10
];
...
List<List<String>> questions = [
  // PyTorch basics questions
  [
    "How do you import the PyTorch library in Python?",
  ...
  [
    "Which class is used to create a tensor in PyTorch?",
    "array",
    "tensor",
    "ndarray",
    "matrix"
  ...
  [
    "Which module in PyTorch is used for automatic differentiation?",
    "autograd",
    "autodiff",
    "diff",
    "grad"
  ...
  [
    "Which class is used as a base class for all neural network modules in PyTorch?",
    "nn.Layer",
    "nn.Model",
    "nn.Module",
    "nn.Network"
  ...
  [
    "Which class is used to load and iterate over datasets in PyTorch?",
    "DataLoader",
    "DatasetLoader",
    "DataIterator",
    "BatchLoader"
  ...
  [
    "Which module in PyTorch is used for optimization algorithms?",
    "optimize",
    "optim",
    "optimizer",
    "optim_alg"
  ...
  [
    "Which method is used to perform backpropagation?",
    "backward",
    "backprop",
    "propagate",
    "backward_pass"
  ...
  [
    "Which function is used to move tensors to a GPU in PyTorch?",
    "gpu",
    "cuda",
    "move_to_gpu",
    "gpu_transfer"
  ...
  [
    "Which library is often used with PyTorch for computer vision tasks?",
    "torchvision",
    "torchimage",
    "cvtorch",
    "imagevision"
  ...
  [
    "Which function is used to save a model or tensor in PyTorch?",
    "store",
    "save",
    "record",
    "serialize"
...
RichText(
 ...
 Container(
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPagePytorch()),
                                                                            );
                                                                          },
                                                                        ),
],
  ...
  DataSnapshot snapshot = await databaseReference.child('Pytorch').child(enrollmentNo).get();
...
int differenceInSeconds = difference.inSeconds%60;
  ...
  //if (!snapshot.exists) {
    await databaseReference.child('Pytorch').child(enrollmentNo).set({
                  '1_Name': name,
...
import 'package:stela_app/screens/PytorchexperimentList.dart'
    as PytorchexperimentList;
