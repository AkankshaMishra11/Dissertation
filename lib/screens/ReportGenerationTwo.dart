...
class PdfPageTwo extends StatefulWidget {
  @override
  _PdfPageTwoState createState() => _PdfPageTwoState();
}

class _PdfPageTwoState extends State<PdfPageTwo> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('AIPT coding-TEST').child(enrollmentNo).child('Experiment 2').once();
