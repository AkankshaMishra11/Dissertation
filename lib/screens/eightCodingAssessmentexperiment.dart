...
import 'package:stela_app/screens/ReportGenerationeight.dart';
...
void main() async {
  ...
  runApp(eightCodingAssessmentExperiment());
}
class eightCodingAssessmentExperiment extends StatefulWidget {
  @override
  _eightCodingAssessmentExperimentState createState() =>
      _eightCodingAssessmentExperimentState();
}
String section1Text = '';
String section2Text = '';
String section3Text = '';
...
class _eightCodingAssessmentExperimentState
    extends State<eightCodingAssessmentExperiment> {
...
final TextEditingController _controller = TextEditingController(text: '''Logical AND: False, Logical OR: True, Logical NOT of a: False''');
...
String universityName = '';
 ...
 String place = '';
  ...
  void initState() {
    ...
    dropdownOptions = [
      [
        DropdownOption(value: 'option1', label: '''def boolean_calculator(a, b, c):
    logical_and = a or b or c
    logical_or = a and b and c
    logical_not = not a
    return logical_and, logical_or, logical_not'''),
        DropdownOption(value: 'option2', label: '''def boolean_calculator(a, b, c):
    logical_and = a and b and c
    logical_or = a or b or c
    logical_not = not a
    return logical_and, logical_or, logical_not'''),
        DropdownOption(value: 'option3', label: '''def boolean_calculator(a, b, c):
    logical_and = a or b or c
    logical_or = a and b and c
    logical_not = not c
    return logical_and, logical_or, logical_not'''),
        DropdownOption(value: 'option4', label: '''def boolean_calculator(a, b, c):
    logical_and = a and b and c
    logical_or = a or b or c
    logical_not = not b
    return logical_and, logical_or, logical_not'''),
      ...
      [
        DropdownOption(value: 'option1', label: '''result = boolean_calculator(False, True, False, True)'''),
        DropdownOption(value: 'option2', label: '''result = boolean_calculator(True, False)'''),
        DropdownOption(value: 'option3', label: '''result = boolean_calculator(True)'''),
        DropdownOption(value: 'option4', label: '''result = boolean_calculator(True, False, True)'''),
      ],
      [
        DropdownOption(value: 'option1', label: '''result_string = f"AND: {result[0]}, OR: {result[1]}, NOT a: {result[2]}"'''),
        DropdownOption(value: 'option2', label: '''result_string = f"And: {result[0]}, Or: {result[1]}, NOT a: {result[2]}"'''),
        DropdownOption(value: 'option3', label: '''result_string = f"Logical AND: {result[0]}, Logical OR: {result[1]}, Logical NOT of a: {result[2]}"'''),
        DropdownOption(value: 'option4', label: '''result_string = f"Logical AND: result[0] Logical OR: {result[1]} Logical NOT of a: {result[2]}"
'''),
      ],
      [
        DropdownOption(value: 'option1', label: '''print(result_string)'''),
        DropdownOption(value: 'option2', label: '''(result_string)'''),
...
RichText(
              ...
              Container(
                ...
                SizedBox(height: 10),
                Text(
                  'Write a Boolean calculator and pass 3 arguments (a,b,c) and showcase logical AND, OR, NOT operations.',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                  ),
                ),
  ...
  child: Column(
    ...
    children: [
      Text(
        'Section 1: Define Boolean Calculator Function (2 marks)',
        style: TextStyle(
          fontWeight: FontWeight.bold,
        ),
      ),
...
Container(
  ...
  child: Column(
    ...
    children: [
      Text(
        'Section 2: Demonstrate Function Call (2 marks)',
        style: TextStyle(
          fontWeight: FontWeight.bold,
        ),
      ),
...
Container(
  ...
  child: Column(
    ...
    children: [
      Text(
        'Section 3: Interpret Results (2 marks)',
        style: TextStyle(
          fontWeight: FontWeight.bold,
        ),
      ),
...
Container(
  ...
  onPressed: () async {
    ...
    DataSnapshot snapshot = await databaseReference.child('AIPT coding-TEST').child(enrollmentNo).child('Experiment 8').get();
...
int differenceInSeconds = difference.inSeconds%60;
        evaluateMarks();
        await databaseReference.child('AIPT coding-TEST').child(enrollmentNo).child('Experiment 8').set({
          '1_Total marks': marks,
                      '2_Section 1': selectedOptions[0] == 'option2' ? 'Correct' : 'Wrong',
                      ...
                      //'6_Execution Result': executionResult == "Logical AND: False, Logical OR: True, Logical NOT of a: False\n" ? 'Correct' : 'Wrong',
       '6_Execution Result': executionResult == expectedOutput+"\n" ? 'Correct' : 'Wrong',
                      ...
                      '9_Code' : program,
                      '10_Aim' : 'Write a Boolean calculator and pass 3 arguments (a,b,c) and showcase logical AND, OR, NOT operations.',
    ...
    /*  } else {
      ...
      setState(() {
                      section1Text = selectedOptions[0] == 'option2' ? 'Correct' : 'Wrong, correct answer is option2';
...
PLEASE WAIT FOR A FEW SECONDS TILL YOU SEE THE OUTPUT''',
    style: TextStyle(
      ...
      fontWeight: FontWeight.bold, // Make the text bold
                ...
                SizedBox(height: 20),
                /*Text(
                  'Correct Result: Logical AND: False, Logical OR: True, Logical NOT of a: False\n',
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),*/
                SizedBox(height: 10),
                Text(
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPageeight()),
                                                                            );
                                                                          },
                                                                        ),
],
...
String executionText = '';
 ...
 String generateProgram() {
  ...
  void evaluateMarks() {
    marks = 0;
    if (selectedOptions[0] == 'option2') marks += 2;
