...
void main() async {
  ...
  runApp(BasicsAssessmentPage());
}

class BasicsAssessmentPage extends StatefulWidget {
  @override
  _BasicsAssessmentPageState createState() => _BasicsAssessmentPageState();
}

class _BasicsAssessmentPageState extends State<BasicsAssessmentPage> {
...
RichText(
 ...
 Container(
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPageBasics()),
                                                                            );
                                                                          },
                                                                        ),
],
  ...
  DataSnapshot snapshot = await databaseReference.child('Basics').child(enrollmentNo).get();
...
int differenceInSeconds = difference.inSeconds%60;
  ...
  //if (!snapshot.exists) {
    await databaseReference.child('Basics').child(enrollmentNo).set({
                  '1_Name': name,
