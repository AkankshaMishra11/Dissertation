...
class PdfPageNumpy extends StatefulWidget {
  @override
  _PdfPageNumpyState createState() => _PdfPageNumpyState();
}

class _PdfPageNumpyState extends State<PdfPageNumpy> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('Numpy').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Numpy', // Your heading text
...
void _captureFacultySign() async {
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Numpy', // Your heading text
