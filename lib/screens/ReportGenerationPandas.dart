...
class PdfPagePandas extends StatefulWidget {
  @override
  _PdfPagePandasState createState() => _PdfPagePandasState();
}

class _PdfPagePandasState extends State<PdfPagePandas> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('Pandas').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Pandas', // Your heading text
...
void _captureFacultySign() async {
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Pandas', // Your heading text
