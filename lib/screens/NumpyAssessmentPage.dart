...
import 'package:firebase_core/firebase_core.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:stela_app/screens/ReportGenerationNumpy.dart';
...
void main() async {
  ...
  runApp(NumpyAssessmentPage());
}

class NumpyAssessmentPage extends StatefulWidget {
  @override
  _NumpyAssessmentPageState createState() => _NumpyAssessmentPageState();
}

class _NumpyAssessmentPageState extends State<NumpyAssessmentPage> {
...
List<List<String>> questions = [
  ...
  [
    "Which function creates an array filled with zeros?",
    "empty",
    "zeros",
    "fill",
    "blank"
  ...
  [
    "Which function returns evenly spaced numbers over a specified interval?",
    "range",
    "linspace",
    "interval",
    "arange"
  ...
  [
    "Which method is used to change the shape of an array?",
    "resize",
    "reshape",
    "transform",
    "modify"
  ...
  [
    "Which attribute of a NumPy array provides the data type of its elements?",
    "type",
    "dtype",
    "datatype",
    "element_type"
  ...
  [
    "Which function calculates the sum of array elements?",
    "add",
    "total",
    "sum",
    "accumulate"
  ...
  [
    "Which function computes the arithmetic mean along the specified axis?",
    "mean",
    "average",
    "median",
    "mode"
  ...
  [
    "Which attribute gives the transpose of a NumPy array?",
    "transpose",
    "T",
    "trans",
    "flip"
  ...
  [
    "Which module in NumPy is used for generating random numbers?",
    "rand",
    "random",
    "rng",
    "randomize"
  ...
  [
    "Which function returns evenly spaced values within a given interval?",
    "range",
    "interval",
    "arange",
    "spacing"
...
RichText(
 ...
 Container(
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPageNumpy()),
                                                                            );
                                                                          },
                                                                        ),
],
  ...
  DataSnapshot snapshot = await databaseReference.child('Numpy').child(enrollmentNo).get();
...
int differenceInSeconds = difference.inSeconds%60;
  ...
  //if (!snapshot.exists) {
    await databaseReference.child('Numpy').child(enrollmentNo).set({
                  '1_Name': name,
...
import 'package:stela_app/screens/NumpyexperimentList.dart'
    as NumpyexperimentList;
