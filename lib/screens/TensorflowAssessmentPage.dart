...
import 'package:firebase_core/firebase_core.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:stela_app/screens/ReportGenerationTensorflow.dart';
...
void main() async {
  ...
  runApp(TensorflowAssessmentPage());
}

class TensorflowAssessmentPage extends StatefulWidget {
  @override
  _TensorflowAssessmentPageState createState() => _TensorflowAssessmentPageState();
}

class _TensorflowAssessmentPageState extends State<TensorflowAssessmentPage> {
...
late String section2= controller.text;
 ...
 List<String> correctAnswers = [
  // TensorFlow basics questions
  "import tensorflow as tf", // Question 1
  "constant", // Question 2
  "Variable", // Question 3
  "placeholder", // Question 4
  "Session", // Question 5
  "TensorBoard", // Question 6
  "Keras", // Question 7
  "train", // Question 8
  "GradientTape", // Question 9
  "tf.data", // Question 10
];
...
List<List<String>> questions = [
  // TensorFlow basics questions
  [
    "How do you import the TensorFlow library in Python?",
  ...
  [
    "Which function is used to create a constant tensor in TensorFlow?",
    "constant_tensor",
    "constant",
    "const",
    "tensor_constant"
  ...
  [
    "Which class is used to create a variable tensor in TensorFlow?",
    "Var",
    "Variable",
    "var_tensor",
    "tensor_var"
  ...
  [
    "Which function is used to create a placeholder for a tensor that will be fed during session run in TensorFlow 1.x?",
    "input",
    "feed",
    "placeholder",
    "hold"
  ...
  [
    "Which class is used to execute a TensorFlow graph in TensorFlow 1.x?",
    "Run",
    "Session",
    "Executor",
    "GraphRunner"
  ...
  [
    "Which tool in TensorFlow provides visualization and tooling for machine learning experimentation?",
    "TensorViewer",
    "TensorBoard",
    "TensorPlot",
    "TensorViz"
  ...
  [
    "Which high-level API is integrated into TensorFlow for building and training models?",
    "Scikit-learn",
    "PyTorch",
    "Keras",
    "Theano"
  ...
  [
    "Which module in TensorFlow is commonly used for training machine learning models?",
    "learn",
    "train",
    "model",
    "fit"
  ...
  [
    "Which API is used for automatic differentiation and gradient computation in TensorFlow 2.x?",
    "tf.Gradient",
    "tf.Autograd",
    "tf.GradientTape",
    "tf.AutoGrad"
  ...
  [
    "Which API is used for building efficient input pipelines in TensorFlow?",
    "tf.data",
    "tf.pipeline",
    "tf.input",
    "tf.loader"
...
RichText(
 ...
 Container(
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPageTensorflow()),
                                                                            );
                                                                          },
                                                                        ),
],
  ...
  DataSnapshot snapshot = await databaseReference.child('Tensorflow').child(enrollmentNo).get();
...
int differenceInSeconds = difference.inSeconds%60;
  ...
  //if (!snapshot.exists) {
    await databaseReference.child('Tensorflow').child(enrollmentNo).set({
                  '1_Name': name,
...
import 'package:stela_app/screens/TensorflowexperimentList.dart'
    as TensorflowexperimentList;
