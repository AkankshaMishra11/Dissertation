...
class twoCodingAssessmentExperiment extends StatefulWidget {
  @override
  _twoCodingAssessmentExperimentState createState() =>
      _twoCodingAssessmentExperimentState();
}
String section1Text = '';
String section2Text = '';
String section3Text = '';
...
class _twoCodingAssessmentExperimentState
    extends State<twoCodingAssessmentExperiment> {
...
int differenceInSeconds = difference.inSeconds%60;
        evaluateMarks();
        await databaseReference.child('AIPT coding-TEST').child(enrollmentNo).child('Experiment 2').set({
          '1_Total marks': marks,
