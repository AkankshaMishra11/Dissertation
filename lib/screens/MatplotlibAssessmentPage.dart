...
import 'package:firebase_core/firebase_core.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:stela_app/screens/ReportGenerationMatplotlib.dart';
...
void main() async {
  ...
  runApp(MatplotlibAssessmentPage());
}

class MatplotlibAssessmentPage extends StatefulWidget {
  @override
  _MatplotlibAssessmentPageState createState() => _MatplotlibAssessmentPageState();
}

class _MatplotlibAssessmentPageState extends State<MatplotlibAssessmentPage> {
...
List<List<String>> questions = [
  ...
  [
    "Which keyword is used to iterate over a sequence (like a list, tuple, or string)?",
    "while",
    "for",
    "loop",
    "iterate"
  ...
  [
    "What is the default return value of a function that does not return any value?",
    "0",
    "null",
    "None",
    "undefined"
  ...
  [
    "Which keyword is used to skip the current iteration of a loop and continue with the next iteration?",
    "skip",
    "continue",
    "break",
    "pass"
...
RichText(
 ...
 Container(
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPageMatplotlib()),
                                                                            );
                                                                          },
                                                                        ),
],
  ...
  DataSnapshot snapshot = await databaseReference.child('Matplotlib').child(enrollmentNo).get();
...
int differenceInSeconds = difference.inSeconds%60;
  ...
  //if (!snapshot.exists) {
    await databaseReference.child('Matplotlib').child(enrollmentNo).set({
                  '1_Name': name,
...
import 'package:stela_app/screens/MatplotlibexperimentList.dart'
    as MatplotlibexperimentList;
