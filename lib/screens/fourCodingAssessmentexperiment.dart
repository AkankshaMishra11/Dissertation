...
import 'package:stela_app/screens/ReportGenerationfour.dart';
...
void main() async {
  ...
  runApp(fourCodingAssessmentExperiment());
}
class fourCodingAssessmentExperiment extends StatefulWidget {
  @override
  _fourCodingAssessmentExperimentState createState() =>
      _fourCodingAssessmentExperimentState();
}
String section1Text = '';
String section2Text = '';
String section3Text = '';
...
class _fourCodingAssessmentExperimentState
    extends State<fourCodingAssessmentExperiment> {
...
final TextEditingController _controller = TextEditingController(text: '''Addition: 12, Subtraction: 4, Multiplication: 32, Division: 2.0''');
String universityName = '';
 ...
 String place = '';
  ...
  void initState() {
    ...
    dropdownOptions = [
      [
        DropdownOption(value: 'option1', label: '''addition = lambda : x * y
subtraction = lambda : x + y
multiplication = lambda : x / y
division = lambda : x % y'''),
        DropdownOption(value: 'option2', label: '''addition = lambda x; y: x - y
subtraction = lambda x; y: x + y
multiplication = lambda x; y: x / y
division = lambda x; y: x * y'''),
        DropdownOption(value: 'option3', label: '''addition = lambda x y: x * y
subtraction = lambda x y: x / y
multiplication = lambda x y: x + y
division = lambda x y: x - y'''),
        DropdownOption(value: 'option4', label: '''addition = lambda x, y: x + y
subtraction = lambda x, y: x - y
multiplication = lambda x, y: x * y
division = lambda x, y: x / y'''),
      ],
      [
        DropdownOption(value: 'option1', label: '''def calculate(operation, x, y):
    return operation(x)'''),
        DropdownOption(value: 'option2', label: '''def calculate(operation, x, y):
    return operation(y)'''),
        DropdownOption(value: 'option3', label: '''def calculate(operation, x, y):
    return operation(x, y)'''),
        DropdownOption(value: 'option4', label: '''def calculate(operation, x, y):
    return operation(y, x)'''),
      ],
      [
        DropdownOption(value: 'option1', label: '''result_addition = calculate(addition)
result_subtraction = calculate(subtraction)
result_multiplication = calculate(multiplication)
result_division = calculate(division)'''),
        DropdownOption(value: 'option2', label: '''result_addition = calculate(addition, 8, 4)
result_subtraction = calculate(subtraction, 8, 4)
result_multiplication = calculate(multiplication, 8, 4)
result_division = calculate(division, 8, 4)'''),
        DropdownOption(value: 'option3', label: '''result_addition = (addition, 5, 3)
result_subtraction = (subtraction, 5, 3)
result_multiplication = (multiplication, 5, 3)
result_division = (division, 5, 3)'''),
        DropdownOption(value: 'option4', label: '''result_addition = calculate(6, 2)
result_subtraction = calculate(6, 2)
result_multiplication = calculate(6, 2)
result_division = calculate(6, 2)
'''),
      ],
      [
        DropdownOption(value: 'option1', label: '''final_result = f"Addition: {result_addition}, Subtraction: {result_subtraction}, Multiplication: {result_multiplication}, Division: {result_division}"
print(final_result)'''),
        DropdownOption(value: 'option2', label: '''final_result = f"Addition: {result_subtraction}, Subtraction: {result_addition}, Multiplication: {result_division}, Division: {result_multiplication}"
print(final_result)'''),
        DropdownOption(value: 'option3', label: '''final_result = f"Addition: {result_multiplication}, Subtraction: {result_division}, Multiplication: {result_addition}, Division: {result_subtraction}"
print(final_result)'''),
        DropdownOption(value: 'option4', label: '''final_result = f"Addition: {result_multiplication}, Subtraction: {result_division}, Multiplication: {result_addition}, Division: {result_subtraction}"
print(final_result)'''),
      ],
    ];
    selectedOptions = [
...
RichText(
              ...
              Container(
                ...
                SizedBox(height: 10),
                Text(
                  'WAP to demonstrate an arithmetic calculator using lambda function',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                  ),
                ),
  ...
  child: Column(
    ...
    children: [
      Text(
        'Section 1: Define Arithmetic Operations using Lambda Functions (2 marks)',
        style: TextStyle(
          fontWeight: FontWeight.bold,
        ),
      ),
...
Container(
  ...
  child: Column(
    ...
    children: [
      Text(
        'Section 2: Function to Perform Arithmetic Operations (2 marks)',
        style: TextStyle(
          fontWeight: FontWeight.bold,
        ),
      ),
...
Container(
  ...
  child: Column(
    ...
    children: [
      Text(
        'Section 3: Perform Arithmetic Operations (2 marks)',
        style: TextStyle(
          fontWeight: FontWeight.bold,
        ),
      ),
...
Container(
  ...
  onPressed: () async {
    ...
    DataSnapshot snapshot = await databaseReference.child('AIPT coding-TEST').child(enrollmentNo).child('Experiment 4').get();
...
int differenceInSeconds = difference.inSeconds%60;
        evaluateMarks();
        await databaseReference.child('AIPT coding-TEST').child(enrollmentNo).child('Experiment 4').set({
          '1_Total marks': marks,
                      '2_Section 1': selectedOptions[0] == 'option4' ? 'Correct' : 'Wrong',
                      '3_Section 2': selectedOptions[1] == 'option3'? 'Correct' : 'Wrong',
                      '4_Section 3': selectedOptions[2] == 'option2'? 'Correct' : 'Wrong',
                      '5_Section 4': selectedOptions[3] == 'option1'? 'Correct' : 'Wrong',
                      //'6_Execution Result': executionResult == "Addition: 12, Subtraction: 4, Multiplication: 32, Division: 2.0\n" ? 'Correct' : 'Wrong',
       '6_Execution Result': executionResult == expectedOutput+"\n" ? 'Correct' : 'Wrong',
                      ...
                      '9_Code' : program,
                      '10_Aim' : 'WAP to demonstrate an arithmetic calculator using lambda function.',
    ...
    /*  } else {
      ...
      setState(() {
                      section1Text = selectedOptions[0] == 'option4' ? 'Correct' : 'Wrong, correct answer is option4';
                      section2Text = selectedOptions[1] == 'option3' ? 'Correct' : 'Wrong, correct answer is option3';
                      section3Text = selectedOptions[2] == 'option2' ? 'Correct' : 'Wrong, correct answer is option2';
                      section4Text = selectedOptions[3] == 'option1' ? 'Correct' : 'Wrong, correct answer is option1';
...
PLEASE WAIT FOR A FEW SECONDS TILL YOU SEE THE OUTPUT''',
    style: TextStyle(
      ...
      fontWeight: FontWeight.bold, // Make the text bold
                ...
                SizedBox(height: 20),
                /*Text(
                  'Correct Result: Addition: 12, Subtraction: 4, Multiplication: 32, Division: 2.0\n',
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),*/
                SizedBox(height: 10),
                Text(
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPagefour()),
                                                                            );
                                                                          },
                                                                        ),
],
...
String executionText = '';
 ...
 String generateProgram() {
  ...
  void evaluateMarks() {
    marks = 0;
    if (selectedOptions[0] == 'option4') marks += 2;
    if (selectedOptions[1] == 'option3') marks += 2;
    if (selectedOptions[2] == 'option2') marks += 2;
    if (selectedOptions[3] == 'option1') marks += 2;
