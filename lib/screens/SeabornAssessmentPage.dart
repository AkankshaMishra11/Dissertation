...
import 'package:firebase_core/firebase_core.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:stela_app/screens/ReportGenerationSeaborn.dart';
...
void main() async {
  ...
  runApp(SeabornAssessmentPage());
}

class SeabornAssessmentPage extends StatefulWidget {
  @override
  _SeabornAssessmentPageState createState() => _SeabornAssessmentPageState();
}

class _SeabornAssessmentPageState extends State<SeabornAssessmentPage> {
...
late String section2= controller.text;
 ...
 List<String> correctAnswers = [
  // Seaborn basics questions
  "import seaborn as sns", // Question 1
  "set_style", // Question 2
  "scatterplot", // Question 3
  "lineplot", // Question 4
  "barplot", // Question 5
  "boxplot", // Question 6
  "heatmap", // Question 7
...
List<List<String>> questions = [
  ...
  [
    "Which function is used to set the aesthetic style of the plots?",
    "style",
    "set_theme",
    "set_style",
    "theme"
  ...
  [
    "Which function is used to create a line plot in Seaborn?",
    "line",
    "linegraph",
    "lineplot",
    "plotline"
  ...
  [
    "Which function is used to create a heatmap in Seaborn?",
    "heatplot",
    "heatgraph",
    "heatmap",
    "hotmap"
  ...
  [
    "Which function is used to plot data and a linear regression model fit in Seaborn?",
    "lmplot",
    "regplot",
    "linearplot",
    "fitplot"
  ...
  [
    "Which function is used to create a count plot in Seaborn?",
    "countgraph",
    "countplot",
    "barcount",
    "countbar"
...
RichText(
 ...
 Container(
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPageSeaborn()),
                                                                            );
                                                                          },
                                                                        ),
],
  ...
  DataSnapshot snapshot = await databaseReference.child('Seaborn').child(enrollmentNo).get();
...
int differenceInSeconds = difference.inSeconds%60;
  ...
  //if (!snapshot.exists) {
    await databaseReference.child('Seaborn').child(enrollmentNo).set({
                  '1_Name': name,
...
import 'package:stela_app/screens/SeabornexperimentList.dart'
    as SeabornexperimentList;
