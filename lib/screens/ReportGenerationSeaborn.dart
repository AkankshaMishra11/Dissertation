...
class PdfPageSeaborn extends StatefulWidget {
  @override
  _PdfPageSeabornState createState() => _PdfPageSeabornState();
}

class _PdfPageSeabornState extends State<PdfPageSeaborn> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('Seaborn').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Seaborn', // Your heading text
...
pw.RichText(
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Seaborn', // Your heading text
