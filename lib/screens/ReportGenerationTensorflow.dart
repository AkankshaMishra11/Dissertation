...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: PdfPageTensorflow(),
    );
  }
}

class PdfPageTensorflow extends StatefulWidget {
  @override
  _PdfPageTensorflowState createState() => _PdfPageTensorflowState();
}

class _PdfPageTensorflowState extends State<PdfPageTensorflow> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final databaseReference = FirebaseDatabase.instance.reference();
      ...
      final DatabaseEvent event =
          await databaseReference.child('Tensorflow').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Tensorflow', // Your heading text
...
void _captureFacultySign() async {
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Tensorflow', // Your heading text
